...
public static class ObjectHelper
{
    ...
    {
        return obj == null ? null : Service.GetSheet<Lumina.Excel.Sheets.BNpcBase>().GetRowOrDefault(obj.DataId);
    }
    ...
    internal static bool CanInterrupt(this IGameObject o)
    {
        ...
        var act = Service.GetSheet<Lumina.Excel.Sheets.Action>().GetRowOrDefault(b.CastActionId);
