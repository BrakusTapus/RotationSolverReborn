...
//            ImGuiToolTipsKirbo.HoveredTooltip(Description);
//        }, ImGui.GetWindowWidth(), textSize);
//        ImGui.NewLine();

//        DisplayStatusHelper.DisplayGCDStatus();
//        DisplayStatusHelper.TripleSpacing();
//        DisplayStatusHelper.DisplayTargetInfo();
//        DisplayStatusHelper.TripleSpacing();
...
//        ImGui.Text("OpenerStep: " + CustomRotationEx.OpenerStep.ToString());
//        ImGui.Text("OpenerHasFinished: " + CustomRotationEx.OpenerHasFinished.ToString());
//        ImGui.Text("OpenerHasFailed: " + CustomRotationEx.OpenerHasFailed.ToString());
//        DisplayStatusHelper.SeparatorWithSpacing();
//        ImGui.Text("OpenerAvailable: " + CustomRotationEx.OpenerAvailable.ToString());
//        ImGui.Text("StartOpener: " + CustomRotationEx.StartOpener.ToString());
//        ImGui.Text("OpenerInProgress: " + CustomRotationEx.OpenerInProgress.ToString());
//        ImGui.EndGroup();
//        DisplayStatusHelper.SeparatorWithSpacing();
//        ImGui.BeginGroup();
//        ImGui.Text("OpenerAvailableNoCountdown: " + CustomRotationEx.OpenerAvailableNoCountdown.ToString());
//        ImGui.Text("StartOpenerNoCountdown: " + CustomRotationEx.StartOpenerNoCountdown.ToString());
//        ImGui.Text("OpenerInProgressNoCountdown: " + CustomRotationEx.OpenerInProgressNoCountdown.ToString());
//        ImGui.EndGroup();
...
//        }
//        DisplayStatusHelper.DrawInfoCollapsible();
